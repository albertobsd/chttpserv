...
HTTP_HEADERS http_headers_init()	{
	...
	keys = (char **) calloc(max_length+1,sizeof(char**));
	values = (char **) calloc(max_length+1,sizeof(char**));
...
void http_headers_increment_max_length(HTTP_HEADERS hh)	{
	hh->max_length *= 2;
	hh->keys =  (char**) realloc( (void*) hh->keys,(hh->max_length +2)* sizeof(char**));
	hh->values = (char**) realloc( (void*) hh->values,(hh->max_length +2) * sizeof(char**));
